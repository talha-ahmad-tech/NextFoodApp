...
import { useFetchProductsQuery } from '../../../services/modules/products.api';
...
const ProductFinishedProductsListing = () => {
  ...
  const { data, isSuccess, isFetching } = useFetchProductsQuery(config.page);
...
export default ProductFinishedProductsListing;
