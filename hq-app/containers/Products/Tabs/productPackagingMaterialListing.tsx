import { columnDefsForPackagingMaterial } from '../config';
...
const ProductPackagingMaterialListing = (
  ...
  const queryPayload = {
    ...
    PageSize: PAGINATION,
    PresetId: props?.payload?.packagingPresetId ?? filters?.PresetId,
  ...
  return (
    <>
      {isFetching || isLoading ? (
        ...
        <AgGrid
          columnDefs={columnDefsForPackagingMaterial}
...
export default forwardRef(ProductPackagingMaterialListing);
