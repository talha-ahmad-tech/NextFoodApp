import DenominationsCreate from '@/containers/Denominations/Add/index';
...
export async function getServerSideProps({
  ...
  const response = await getMethod({
    url: `${DenominationsApis.DenominationsDetails(Number(params?.id))}`,
...
export default DenominationsCreate;
